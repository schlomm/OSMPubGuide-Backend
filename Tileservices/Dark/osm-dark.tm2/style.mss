// Help here: https://www.mapbox.com/developers/vector-tiles/mapbox-streets/#
// Common Colors
...
#landuse {
  ...
  [class='park'] { polygon-fill: #2A4028; }
  [class='cemetery'] { polygon-fill: mix(#565D50, #000000, 25%); }
  [class='hospital'] { polygon-fill: #2E131C; }
  [class='school'] { polygon-fill: #48464A; }
  ::overlay {
    // Landuse classes look better as a transparent overlay.
    opacity: 0.4;
    [class='wood'] { polygon-fill: #13200D; polygon-gamma: 0.5; }
  }
}
...
#building [zoom>=16]{
::wall { polygon-fill:mix(@land, #A7A7A7, 80); }
::roof {
